...
class ViewController: UIViewController,CBCentralManagerDelegate,CBPeripheralDelegate {
    ...
    override func viewDidLoad() {
        ...
        //设置按钮的文字
        open.setTitle("打开", for: UIControl.State())
        //设置按钮的点击事件
        open.addTarget(self, action: #selector(ViewController.buttonTag(_:)), for: UIControl.Event.touchUpInside)
        open.tag = 10
        ...
        //设置按钮的文字
        open1.setTitle("发送读取数据指令", for: UIControl.State())
        //设置按钮的点击事件
        open1.addTarget(self, action: #selector(ViewController.buttonTag(_:)), for: UIControl.Event.touchUpInside)
        open1.tag = 20
    ...
    @objc func buttonTag(_ btn:UIButton) {
